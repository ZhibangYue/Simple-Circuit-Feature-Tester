...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  {
    /* Integer part computing in case Oversampling mode is 8 Samples  ( used 25 now 8 )*/
    integerdivider = ((8 * apbclock) / (2 * (USART_InitStruct->USART_BaudRate)));    
  }
  else /* if ((USARTx->CR1 & USART_CR1_OVER8) == 0) */
  {
    /* Integer part computing in case Oversampling mode is 16 Samples ( used 25 now 8 )*/
